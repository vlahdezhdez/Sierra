...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11882456.366679, 3688330.221168, -11827690.373059, 3735723.808811],
            units: 'm'
        })
    })
});
...
map.getView().fit([-11876839.010149, 3705434.359792, -11830770.400306, 3738080.796993], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sierra de Juárez</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (694 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este proyecto presenta una lectura cartográfica de las transformaciones recientes en la Sierra de Juárez y su relación con el crecimiento de Ciudad Juárez. El análisis integra la superficie urbana registrada en 2000 y 2026, la localización de bancos de materiales y la presencia de tiraderos. La comparación espacial permite reconocer el avance de la urbanización hacia el entorno serrano y ubicar actividades que ejercen presión sobre su paisaje. Los mapas fueron elaborados en QGIS mediante imágenes satelitales y una base cartográfica oscura, con el propósito de facilitar la observación de los cambios territoriales y aportar elementos para la conservación y gestión ambiental de la sierra.';
            }
